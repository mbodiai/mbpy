...
def main() -> None:
    ...
    with open(file_orig, encoding="utf-8") as f:
        lines_orig = f.readlines()

    with open(file_updated, encoding="utf-8") as f:
...
def diff_partial_update(lines_orig, lines_updated, final=False, fname=None):
    ...
    last_non_deleted = num_orig_lines if final else find_last_non_deleted(lines_orig, lines_updated)
