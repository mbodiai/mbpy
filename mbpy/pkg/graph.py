...
from typing import TYPE_CHECKING, Any, Callable, Dict, List, NamedTuple, Optional, Set, Tuple, TypeVar, Union, cast, overload, get_type_hints,TypedDict,ParamSpec
...
if TYPE_CHECKING:
    ...
    from more_itertools import all_unique, first_true, ilen, unique_everseen
...
if TYPE_CHECKING:
    ...
    from mbpy.collect.compose import compose
    from pydantic import BaseModel as DataModel
else:
    _MetaT = type
    dataclass_transform = smart_import("typing.dataclass_transform")
