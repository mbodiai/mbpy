...
#   timestamp: 2024-11-20T02:28:07+00:00
...
class DependencyGroups(DataModel):
    ...
    include_group: (
        constr(pattern="^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9._-]*[a-zA-Z0-9])$") | None
    ) = Field(None, alias="include-group")
...
class BuildFrontendModel(
    ...
    root: (
        BuildFrontend2
        | constr(pattern="^pip; ?args:")
        | constr(pattern="^build; ?args:")
        | constr(pattern="^build\\[uv\\]; ?args:")
        | BuildFrontend3
    ) = Field(
        ...,
...
class ContainerEngineModel(
    ...
    root: (
        ContainerEngine2
        | constr(pattern="^docker; ?(create_args|disable_host_mount):")
        | constr(pattern="^podman; ?(create_args|disable_host_mount):")
        | ContainerEngine3
    ) = Field(..., title="CIBW_CONTAINER_ENGINE")
...
class Cmake(DataModel):
    ...
    define: Dict[constr(pattern=".+"), str | bool | Define] | None = Field(
        None,
...
class Project(DataModel):
    ...
    version: (
        ...
        | None
    ) = Field(None, examples=["42.0.1", "0.3.9rc7.post0.dev5"], title="Project version")
    ...
    optional_dependencies: (
        Dict[
            constr(pattern="^([a-z\\d]|[a-z\\d]([a-z\\d-](?!--))*[a-z\\d])$"), List[str]
        ]
        | None
    ) = Field(
        None,
...
class PartialCibuildwheel(DataModel):
    ...
    container_engine: (
        ...
        | ContainerEngine1
        | None
    ) = Field(None, alias="container-engine", title="CIBW_CONTAINER_ENGINE")
...
class Dynamic1(DataModel):
    ...
    optional_dependencies: (
        Dict[constr(pattern=".+"), FileDirectiveForDependencies] | None
    ) = Field(None, alias="optional-dependencies")
...
class ExecutionEnvironment(DataModel):
    ...
    reportIncompatibleVariableOverride: ReportIncompatibleVariableOverride | None = None
    ...
    reportUninitializedInstanceVariable: ReportUninitializedInstanceVariable | None = (
        None
    )
    reportInvalidStringEscapeSequence: ReportInvalidStringEscapeSequence | None = None
    ...
    reportImplicitStringConcatenation: ReportImplicitStringConcatenation | None = None
    ...
    reportUnnecessaryTypeIgnoreComment: ReportUnnecessaryTypeIgnoreComment | None = None
...
class PartialPoetry(DataModel):
    ...
    dev_dependencies: (
        Dict[constr(pattern="^[a-zA-Z-_.0-9]+$"), PoetryDependencyAny] | None
    ) = Field(
        None,
        alias="dev-dependencies",
    ...
    scripts: (
        Dict[
            constr(pattern="^[a-zA-Z-_.0-9]+$"), PoetryScriptLegacy | PoetryScriptTable
        ]
        | None
    ) = Field(None, description="A hash of scripts to be installed.")
    plugins: (
        Dict[constr(pattern="^dotenv$"), Plugins1]
        | Dict[
            constr(pattern="^[a-zA-Z-_.0-9]+$"),
            Dict[constr(pattern="^[a-zA-Z-_.0-9]+$"), str],
        ]
        | None
...
class Mb(DataModel):
    """Metadata and configuration for mb."""
...
class PyProject(DataModel):
    ...
    dependency_groups: (
        Dict[
            constr(pattern="^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9._-]*[a-zA-Z0-9])$"),
            List[str | DependencyGroups],
        ]
        | None
    ) = Field(None, alias="dependency-groups", title="PEP 735 dependency groups")
